...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"SelGrupo\")";
mostCurrent._activity.LoadLayout("SelGrupo",mostCurrent.activityBA);
 //BA.debugLineNum = 23;BA.debugLine="Mes=0";
_mes = (int) (0);
 //BA.debugLineNum = 24;BA.debugLine="DateTime.DateFormat=\"M\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("M");
 //BA.debugLineNum = 25;BA.debugLine="Mes=DateTime.Date(DateTime.Now)";
_mes = (int)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow())));
 //BA.debugLineNum = 26;BA.debugLine="Label1.Text=Mes";
mostCurrent._label1.setText(BA.ObjectToCharSequence(_mes));
 //BA.debugLineNum = 27;BA.debugLine="If Mes>=2 And Mes<=8 Then";
if (_mes>=2 && _mes<=8) { 
 //BA.debugLineNum = 28;BA.debugLine="Periodo=True'Significa que esta en el periodo 1";
_periodo = anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 30;BA.debugLine="Periodo=False'Significa que esta en el periodo 2";
