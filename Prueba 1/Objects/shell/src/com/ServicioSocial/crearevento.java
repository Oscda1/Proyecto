...
public static com.ServicioSocial.principal _principal = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",crearevento.mostCurrent._activity,"BarraTitulo",crearevento.mostCurrent._barratitulo,"DateUtils",crearevento.mostCurrent._dateutils,"ImagenRegresar",crearevento.mostCurrent._imagenregresar,"Main",Debug.moduleToString(com.ServicioSocial.main.class),"NombreEventoEditText",crearevento.mostCurrent._nombreeventoedittext,"Principal",Debug.moduleToString(com.ServicioSocial.principal.class),"Starter",Debug.moduleToString(com.ServicioSocial.starter.class)};
}
}