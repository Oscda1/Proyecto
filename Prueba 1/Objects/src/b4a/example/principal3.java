...
public class principal3 extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.principal3");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (principal3).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.principal3");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.principal3", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (principal3) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (principal3) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (principal3) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
RDebugUtils.currentLine=1769505;
 //BA.debugLineNum = 1769505;BA.debugLine="Sale=False";
_sale = anywheresoftware.b4a.keywords.Common.False;
RDebugUtils.currentLine=1769506;
 //BA.debugLineNum = 1769506;BA.debugLine="Contador=-1";
_contador = (int) (-1);
RDebugUtils.currentLine=1769507;
 //BA.debugLineNum = 1769507;BA.debugLine="DetallesEventos.Text=\"El evento \"&NombreEvento&\"";
...
RDebugUtils.currentLine=1769508;
 //BA.debugLineNum = 1769508;BA.debugLine="Do While Sale=False";
while (_sale==anywheresoftware.b4a.keywords.Common.False) {
RDebugUtils.currentLine=1769509;
 //BA.debugLineNum = 1769509;BA.debugLine="Try";
try {RDebugUtils.currentLine=1769510;
 //BA.debugLineNum = 1769510;BA.debugLine="Contador=Contador+1";
_contador = (int) (_contador+1);
RDebugUtils.currentLine=1769511;
 //BA.debugLineNum = 1769511;BA.debugLine="DetallesEventos.Text=DetallesEventos.Text&Grup";
mostCurrent._detalleseventos.setText(BA.ObjectToCharSequence(mostCurrent._detalleseventos.getText()+_grupos[_contador]+anywheresoftware.b4a.keywords.Common.CRLF));
			...
			processBA.setLastException(e40);RDebugUtils.currentLine=1769513;
 //BA.debugLineNum = 1769513;BA.debugLine="Sale=True";
_sale = anywheresoftware.b4a.keywords.Common.True;
 };
 }
;
