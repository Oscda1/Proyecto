...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.Cetis58.SaveIt", "com.Cetis58.SaveIt.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.Cetis58.SaveIt", "com.Cetis58.SaveIt.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.Cetis58.SaveIt.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.Cetis58.SaveIt.gifviewer _logo = null;
...
mostCurrent._activity.LoadLayout("SplashScreen",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="CheckForWiFi";
_checkforwifi();
 //BA.debugLineNum = 34;BA.debugLine="If (ConexionAInternet= False) Then";
if ((_conexionainternet==anywheresoftware.b4a.keywords.Common.False)) { 
 //BA.debugLineNum = 35;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 37;BA.debugLine="tiempo.Initialize(\"tiempo\",8000)";
_tiempo.Initialize(processBA,"tiempo",(long) (8000));
 //BA.debugLineNum = 38;BA.debugLine="tiempo.Enabled=True";
_tiempo.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 40;BA.debugLine="Logo.SetGif(File.DirAssets,\"ezgif-5-f296a6c87 (1)";
mostCurrent._logo._setgif(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ezgif-5-f296a6c87 (1).gif");
 //BA.debugLineNum = 41;BA.debugLine="Logo.Start";
mostCurrent._logo._start();
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 59;BA.debugLine="Logo.Start";
mostCurrent._logo._start();
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public static String  _checkforwifi() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub CheckForWiFi";
 //BA.debugLineNum = 45;BA.debugLine="If Conexion.isOnLine=False Then";
if (_conexion.isOnLine(processBA)==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 46;BA.debugLine="ToastMessageShow(\"No tiene conexion a internet\",";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("No tiene conexion a internet"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 47;BA.debugLine="ConexionAInternet=False";
_conexionainternet = anywheresoftware.b4a.keywords.Common.False;
 }else {
 //BA.debugLineNum = 49;BA.debugLine="ToastMessageShow(\"Tiene conexion a internet\",Tru";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Tiene conexion a internet"),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 50;BA.debugLine="ConexionAInternet=True";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 28;BA.debugLine="Private Logo As GifViewer";
mostCurrent._logo = new com.Cetis58.SaveIt.gifviewer();
...
seleccionargrupos._process_globals();
...
_conexion = new wifi.MLwifi();
 //BA.debugLineNum = 22;BA.debugLine="Dim btmp As Bitmap";
...
public static String  _tiempo_tick() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub tiempo_Tick";
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(Principal)";
